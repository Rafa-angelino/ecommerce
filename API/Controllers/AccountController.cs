...
namespace API.Controllers
{
    public class AccountController : BaseApiController
    {
        ...
        public AccountController(UserManager<AppUser> userManager,
         SignInManager<AppUser> signInManager, ITokenInterface tokenService, IMapper mapper) 
        {
        ...
        public async Task<ActionResult<AddressDto>> UpdateUserAdress(AddressDto address)
        {
            ...
            return BadRequest("Problema ao atualizar o endereço do usuário");
        }
